...
export class SMcLvAdapter{
     ...
     * @param flags ArrayBuffer, View it as Uint32Array. sort flags for every column
     */
    onSort:(iCol:number,flags:ArrayBuffer)=>boolean;
    ...
    /**
     * set column width
     * @param colWids int ArrayBuffer
     */
    onSetColumnWidth:(colWids:ArrayBuffer)=>void;
}
