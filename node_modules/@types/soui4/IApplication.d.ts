...
export class IApplication extends IObjRef{
   ...
   GetRenderFactory():IRenderFactory;
     ...
     */
	SetRenderFactory(renderFac:IRenderFactory) :boolean;
    ...
    * @param arrNames array of names--控件名表
    * @param arrIds array of ids--控件ID表
    * @return true-succeed
    * @remark 数据表由residbuilder工具自动生成, arrNames and arrIds must be same size.
    */
   InitXmlNamedID(arrNames:Array, arrIds:Array) :boolean;
