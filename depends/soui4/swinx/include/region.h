...
HRGN WINAPI CreateEllipticRgn(int nLeftRect,  // x-coord of upper-left corner of rectangle
...
HRGN WINAPI CreateRectRgn(int nLeftRect,  // x-coordinate of upper-left corner
...
HRGN WINAPI CreateRoundRectRgn(int nLeftRect,     // x-coordinate of upper-left corner
                               int nTopRect,      // y-coordinate of upper-left corner
                               int nRightRect,    // x-coordinate of lower-right corner
                               int nBottomRect,   // y-coordinate of lower-right corner
...
BOOL WINAPI EqualRgn(HRGN hSrcRgn1, // handle to first region
...
HRGN WINAPI ExtCreateRegion(CONST XFORM *lpXform,    // transformation data
                            DWORD nCount,            // size of region data
                            CONST RGNDATA *lpRgnData // region data buffer
);

DWORD WINAPI GetRegionData(HRGN hRgn,         // handle to region
...
BOOL WINAPI RectInRegion(HRGN hrgn,       // handle to region
